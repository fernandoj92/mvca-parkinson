...
public class FlatLTM_creator {
    ...
    public static LTM createFromIslands(Collection<LTM> islands, DirectedTree latentVarTree, DataSet dataSet){
     ...
     * @return
     */
    public static LTM applyChowLiuWithBestRoot(Collection<LTM> islands, DataSet dataSet){
