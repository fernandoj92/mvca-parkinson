...
// TODO: importar excepcion especifica del package superoir
public class BifParser extends AbstractParser implements BifParserConstants {
        public void parse(BayesNet network) throws CustomParseException {
                try {
        ...
        private static int computeNumberOfCells(ArrayList<DiscreteVariable> variables) {
                if (variables.size() == 0)
                        return 0;
...
/**
	...
	of these variables.
*/
  final public Function ProbabilityDefinition(ArrayList<DiscreteVariable> variables) throws ParseException {
        double probability;
    ...
    case CONNECTION_CONSTRAINT:
      ...
      text = QuotedStringValue();
                property.setConnectionConstraint(
                        Enum.valueOf(BeliefNodeProperty.ConnectionConstraint.class, text));
      break;
    default:
      jj_la1[17] = jj_gen;
      jj_consume_token(-1);
