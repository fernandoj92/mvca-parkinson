...
public class LTM extends BayesNet {
	 ...
	 */
	public static LTM createLCM(ArrayList<DiscreteVariable> maniVars, int cardinality) {

		LTM lCM = new LTM();
		BeliefNode root = lCM.addNode(new DiscreteVariable(cardinality));
	...
	public static LTM createLCM(DiscreteVariable[] maniVars, int cardinality) {
	 ...
	 */
	public LTM changeRoot(DiscreteVariable var) {
	 ...
	 * @return
	 */
	public LTM manipulation_VariableReplacement(DiscreteVariable latVar, DiscreteVariable newVar) {
		LTM template = clone();
	 ...
	 *         deleted.
	 */
	public LTM manipulation_NodeDeletion(DiscreteVariable v2Delete, DiscreteVariable dockVar) {
		LTM candModel = clone();
	 ...
	 * @return
	 */
	public LTM manipulation_NodeRelocation(DiscreteVariable alterVar) {
		LTM candModel = clone();
	...
	public ArrayList<DiscreteVariable> getLatVarsfromTop(){
		ArrayList<DiscreteVariable> LatVarsOrdered = new ArrayList<DiscreteVariable>();
      //Since queue is a interface
        Queue<DiscreteVariable> queue = new LinkedList<DiscreteVariable>();
	...
	public LTM introduceParent4Siblings(BeliefNode child1, BeliefNode child2) {
		...
		BeliefNode newNode = candModel.addNode(new DiscreteVariable(2));
	...
	public LTM introduceState4Root() {
		...
		BeliefNode newRootNode = candModel.addNode(new DiscreteVariable(rootVar
				.getCardinality() + 1));
...
//	}
	 ...
	 * @param vars
	 */
	public void synchronize(DiscreteVariable[] vars) {
		for (int i = 0; i < vars.length; i++) {
			DiscreteVariable newVar = vars[i];
