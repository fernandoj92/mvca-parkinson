...
import voltric.graph.AbstractGraph;
...
public class BeliefNode extends DirectedNode {
	 ...
	 * 
	 */
	public void replaceVar(DiscreteVariable newVar) {
		if (_cpt != null) {
	...
	public final ArrayList<DiscreteVariable> getChildrenVars() {
	...
	public final ArrayList<DiscreteVariable> getChildrenLatVars() {
		ArrayList<DiscreteVariable> children = new ArrayList<DiscreteVariable>();
		for(DirectedNode n: _children.keySet()){
	...
	public final ArrayList<DiscreteVariable> getChildrenManiVars() {
		ArrayList<DiscreteVariable> children = new ArrayList<DiscreteVariable>();
		for(DirectedNode n: _children.keySet()){
			if(((BeliefNode)n).isLeaf()){
			children.add(((BeliefNode)n).getVariable());
	 ...
	 * @see BayesNet#randomlyParameterize(Collection)
	 */
	 ...
	 */
	public ArrayList<DiscreteVariable> getNodeAndParentVariables() {
		ArrayList<DiscreteVariable> list = new ArrayList<DiscreteVariable>(
				getParents().size() + 1);
