...
//	private double _thresholdBIC = 0.01;
	 ...
	 */
	public LTM search(DiscreteDataSet dataSet) throws FileNotFoundException, UnsupportedEncodingException {
	 ...
	 */
	public LTM search(LTM initModel, DiscreteDataSet data, int cardinality)
	{
		setEMLearner();
		...
		while (true) 
		{
			...
			// Generate next model
			DiscreteVariable[] maniVars = data.getVariables();
