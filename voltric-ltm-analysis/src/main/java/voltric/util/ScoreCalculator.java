...
public class ScoreCalculator {
	 ...
	 */
	public static double computeAic(BayesNet model, DiscreteDataSet data) {
	 ...
	 */
	public static double computeBic(BayesNet model, DiscreteDataSet data) {
		return computeLoglikelihood(model, data) - model.computeDimension()
	 ...
	 */
	public static double computeLoglikelihood(BayesNet model, DiscreteDataSet data) {
		// synchronize first
	 ...
	 *         specified data.
	 */
	public static double computeCll(BayesNet model, DiscreteDataSet data,
	 ...
	 */
	public static double computeScore(BayesNet model, DiscreteDataSet data, String score) {
		if (score.equals("BIC")) {
	...
	public double computeMaximumLoglikelihood_CompletedData(LTM model,
		...
		for (AbstractNode Anode : model.getNodes()) {
			...
			DiscreteVariable vi = Bnode.getVariable();
			if (Bnode.isRoot()) {
				...
				DiscreteVariable vj = parent.getVariable();
	 ...
	 * @return
	 */
	private void computeCtps(LTM model, DiscreteDataSet data) {
