...
/**
 * <p>
 * This class provides an implementation for nominal getVariables. Although the
...
public class DiscreteVariable extends Variable {
    ...
    /**
     * Constructs a variable with the specified getName and the specified list of
     * states.
     *
     * @param name
     *            getName of the variable to be created.
     * @param states
     ...
     * and (2) it has the same getName and the same list of states as this
     * variable.
     *
