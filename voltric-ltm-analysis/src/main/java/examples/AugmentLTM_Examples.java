...
public class AugmentLTM_Examples {
    ...
    private static LTM handMade2LTM(DiscreteDataSet data){
        LTM ltm = new LTM();
        BeliefNode variable22 = ltm.addNode(new DiscreteVariable(2));
        BeliefNode variable30 = ltm.addNode(new DiscreteVariable(2));
    ...
    private static LTM learnWithBI(DiscreteDataSet data) throws IOException{
    ...
    private static void showCTPs(LTM ltm){
        for(DiscreteVariable var: ltm.getVariables())
