...
public class newBifWriter {
     ...
     */
    public newBifWriter(OutputStream output) throws UnsupportedEncodingException {
     ...
     * @throws UnsupportedEncodingException
     */
    public newBifWriter(OutputStream output, boolean useTableFormat)
            throws UnsupportedEncodingException {
    ...
    private void writeProbabilities(BeliefNode node) {
        ...
        ArrayList<DiscreteVariable> variables = node.getNodeAndParentVariables();
    ...
    private void writeScore(BayesNet network, DiscreteDataSet data) {
        writer.println();
