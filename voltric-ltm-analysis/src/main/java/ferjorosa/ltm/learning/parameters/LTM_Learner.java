...
public class LTM_Learner {
    ...
    public static LTM learnParametersSingle(LTM ltm, DiscreteDataSet data){
        int _EmMaxSteps = 50;
    ...
    public static LTM  learnParametersSingle(LTM ltm, DiscreteDataSet data, int emMaxSteps, int emNumRestarts, double emThreshold){
